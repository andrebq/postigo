...
Postigo is a self-hosted reverse tunnel broker. Your nodes connect out to a public VPS and register named tunnels over WebSocket, making their services reachable from anywhere without exposing them directly to the internet. The VPS is the wall; the tunnel is the postigo.